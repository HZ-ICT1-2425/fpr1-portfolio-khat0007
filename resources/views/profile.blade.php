    ...
    <section>
        <img src="{{asset('images/my own.webp') }}" width="450" height="450" alt="">

        <h1 class="title is-5">About me</h1>
        <p class="para">My name is Shaiza Khatoon, and I am 26 years old. I am from Pakistan, a country that holds a
            special
        ...
        <p class="para">My childhood dream was to become an IT expert, as I have always been fascinated by technology
            and its
