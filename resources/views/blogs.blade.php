<x-layout.layout>
    ...
    <div class="container">
        @foreach($blogs as $blog)
            ...
            <p><a href="{{ route('blogs.show', $blog['slug']) }}">read more...</a></p>
            ...
            <br>
                            <h1 class="title is-9">The Field of ICT</h1>
                <img src="{{asset ('images/field-of-ICT.jpg') }}" width="400" height="220" alt="">

                <artical>The Information and Communication Technology (ICT) field at HZ University of Applied Sciences
                    is
                    designed to equip students with cutting-edge technical knowledge
                </artical>
                <p><a href="{{ route('blogs.show', $blog['slug']) }}">read more...</a></p>
                @endforeach
    </div>
