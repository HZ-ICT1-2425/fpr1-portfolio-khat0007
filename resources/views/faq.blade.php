    ...
    <div class="container">
        ...
        <details>
            ...
            <div>
                ...
                <ol>
                    <li>Click <a href="https://hz.mynetpay.nl/">here</a> and log in with your HZ username and password.
                    </li>
                    <br>
                    <li>Tap <b>Web Print.</b></li>
                    <br>
                    <li>At <b>Step 1: Select a printer,</b> check the settings (format, single/double sided etc).</li>
                    <br>
                    <li>Click in the field at <b>Step 2: Select files</b> to choose your files (you can also drag and
                        drop).
                    </li>
                    <br>
                ...
                <ol>
                    ...
                    <br>
                    <li>When the print command is given, log on to the printer by entering your HZ card or
                        username/password.
                    </li>
                    <br>
                    <li>On the printer, press <b>Print Release.</b></li>
                    <br>
                    <li>After scanning, press the following symbol on the printer to log of.</li>
                </ol>
            </div>
        </details>
        ...
        <details>
            ...
            <div>
                <ol>
                    <li>Log on to the printer using your HZ card or by entering your HZ user name and password.</li>
                    <br>
        ...
        <details>
            ...
            <div>
                You go to the <a
                    ...
                    Webshop</a> and log in into your HZ account. After that, you should be able to see the options.
            </div>
        </details>
        ...
        <details>
            ...
            <div>
                ...
                Select "make a reservation", then your room of choice. Be aware that only the rooms that start with GW
                are in
                Middelburg!
                <br><br><b>Terms of supply</b>
                <br>If you are not present in the meeting room 15 minutes after the start of your reservation, your
                reservation will be
        ...
        <details>
            ...
            <div>
                ...
                Free parking is available at the car park at Poelendaelesingel 12 in Middelburg. This is at a few
                minutes’ walk from HZ.
                Unfortunately, it is not possible to park directly at the HZ premises. However, there is a disabled
                parking space available
                right next to the HZ building at Het Groene woud 1-3.

                <br><br><b>Car park Poelendaelesingel</b><br>
                At the barrier of the car park the Poelendaelesingel you can ring the bell. After passing the barrier,
                follow the signs to
                the HZ parking places, marked with a white sign with the HZ logo.

                <br><br><b>With HZ pass or ring the bell</b><br>
                Students and staff can only enter by presenting their HZ pass at the barriers, guests can ring the bell
                at the barrier.
